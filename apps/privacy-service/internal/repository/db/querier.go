...
type Querier interface {
	...
	CreateMagicToken(ctx context.Context, arg CreateMagicTokenParams) (MagicToken, error)
	CreateNominee(ctx context.Context, arg CreateNomineeParams) (Nominee, error)
	CreatePrivacyRequest(ctx context.Context, arg CreatePrivacyRequestParams) (PrivacyRequest, error)
	CreatePurpose(ctx context.Context, arg CreatePurposeParams) (CreatePurposeRow, error)
	...
	GetMagicToken(ctx context.Context, token string) (MagicToken, error)
	GetPrivacyRequest(ctx context.Context, arg GetPrivacyRequestParams) (PrivacyRequest, error)
	GetPurpose(ctx context.Context, arg GetPurposeParams) (GetPurposeRow, error)
	...
	GetUserNominees(ctx context.Context, userEmail string) ([]Nominee, error)
	...
	ListPurposes(ctx context.Context, organizationID pgtype.UUID) ([]ListPurposesRow, error)
	...
	ListUserGrievances(ctx context.Context, reporterEmail pgtype.Text) ([]Grievance, error)
	ListUserPrivacyRequests(ctx context.Context, requesterEmail pgtype.Text) ([]PrivacyRequest, error)
	MarkMagicTokenUsed(ctx context.Context, id pgtype.UUID) error
	RecordConsentReceipt(ctx context.Context, arg RecordConsentReceiptParams) (ConsentReceipt, error)
	...
	UpdateNomineeStatus(ctx context.Context, arg UpdateNomineeStatusParams) (Nominee, error)
	UpdatePrivacyRequest(ctx context.Context, arg UpdatePrivacyRequestParams) (PrivacyRequest, error)
	UpdatePurpose(ctx context.Context, arg UpdatePurposeParams) (UpdatePurposeRow, error)
