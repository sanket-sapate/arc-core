...
) RETURNING id, organization_id, domain, name, title, message, accept_button_text, reject_button_text, settings_button_text, theme, position, active, config, created_at, updated_at
`
...
func (q *Queries) CreateCookieBanner(ctx context.Context, arg CreateCookieBannerParams) (CookieBanner, error) {
	row := q.db.QueryRow(ctx, createCookieBanner,
		...
		arg.Title,
		arg.Message,
		arg.AcceptButtonText,
		arg.RejectButtonText,
		arg.SettingsButtonText,
		arg.Theme,
		arg.Position,
		arg.Active,
		arg.Config,
...
SELECT id, organization_id, domain, name, title, message, accept_button_text, reject_button_text, settings_button_text, theme, position, active, config, created_at, updated_at FROM cookie_banners
WHERE id = $1 AND organization_id = $2
`
...
func (q *Queries) ListCookieBanners(ctx context.Context, organizationID pgtype.UUID) ([]CookieBanner, error) {
