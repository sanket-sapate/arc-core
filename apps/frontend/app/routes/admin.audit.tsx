...
import { useAuditLogs, type AuditLog } from "../features/settings/api/audit";
import {
    Table,
    TableBody,
    TableCell,
...
export const meta: MetaFunction = () => {
    return [
        { title: "Global Audit Logs | ARC Admin" },
        { name: "description", content: "View the complete audit trail of actions." },
    ];
};
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">
                        Comprehensive immutable record of all destructive and configuration events.
                    </p>
                </div>
            </div>
                ...
                <Table>
                    ...
                    <TableBody>
                        {isLoading ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={4} className="h-24 text-center text-muted-foreground">No audit logs available for this tenant scope.</TableCell>
                            </TableRow>
                        ) : (
                                ...
                                <TableRow key={log.id} className="hover:bg-muted/50 cursor-default">
                                    ...
                                    <TableCell>
                                        <div className="flex items-center gap-2 text-sm">
                                            ...
                                            <span className="capitalize text-slate-700 dark:text-slate-300">{log.entity_type}</span>
                                            <span className="font-mono text-xs text-muted-foreground truncate max-w-[120px]">({log.entity_id})</span>
                                        </div>
                                    </TableCell>
                                    <TableCell>
