...
export default function DiscoveryDashboardPage() {
    ...
    const findingsTotal = useMemo(() => {
        ...
        return Object.values(stats.findings_by_likelihood as Record<string, number>).reduce((a: number, b: number) => a + b, 0);
    }, [stats]);
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
                ...
                <Button asChild>
                    <NavLink to="/app/data-intelligence/sources">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                ...
                <div className="lg:col-span-1 rounded-xl border bg-card p-5 shadow-sm space-y-4">
                    ...
                    {statsLoading ? (
                        ...
                        <LikelihoodChart
                            data={(stats?.findings_by_likelihood as Record<string, number>) ?? {}}
                            total={findingsTotal}
                        />
                    )}
                </div>
                ...
                <div className="lg:col-span-2 rounded-xl border bg-card p-5 shadow-sm space-y-4">
                    ...
                    {statsLoading ? (
                        ...
                        <InfoTypeChart data={(stats?.findings_by_type as Record<string, number>) ?? {}} />
                    )}
                </div>
            </div>
                ...
                <div className="rounded-xl border bg-card shadow-sm">
                    <div className="flex items-center justify-between px-5 py-4 border-b">
                        ...
                        <Button variant="ghost" size="sm" asChild className="text-xs text-muted-foreground">
                            <NavLink to="/app/data-intelligence/jobs">View all <ArrowRight className="ml-1 h-3 w-3" /></NavLink>
                        </Button>
                    </div>
                    <div className="p-3">
                        <RecentJobs />
