...
export default function RolesPage() {
    ...
    const getPermCountBadge = (count: number) => {
        if (count === 0) return <Badge variant="outline" className="text-muted-foreground">No permissions</Badge>;
        if (count <= 3) return <Badge className="bg-amber-500/15 text-amber-600 hover:bg-amber-500/25 border-none">{count} permissions</Badge>;
        return <Badge className="bg-emerald-500/15 text-emerald-600 hover:bg-emerald-500/25 border-none">{count} permissions</Badge>;
    };
                        ...
                        {isLoading ? (
                            ...
                            (roles || []).map((role: Role) => (
                                ...
                                >
                                    ...
                                    <TableCell>
                                        {getPermCountBadge(role.permissions?.length || 0)}
                                    </TableCell>
